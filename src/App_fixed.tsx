...
import globeSwiftGoLogo from 'figma:asset/f85235f8ed56ad2ea6722cce8b232b67e13a741e.png';
...
import exampleImage from 'figma:asset/a4cee0e3594d7d7bfc5b220b51c4efba05150515.png';
        ...
        return (
          <div className="p-6 lg:p-8 space-y-8 w-full">
            <div className="space-y-2">
              ...
              <p className="text-muted-foreground text-lg">Track individual parcels and their delivery status</p>
            </div>
            <div className="w-full p-12 text-center text-muted-foreground border-2 border-dashed border-border rounded-lg bg-card">
              <Package className="h-16 w-16 mx-auto mb-6 text-muted-foreground" />
              <h3 className="text-xl font-medium mb-2">Parcel Tracking System</h3>
              <p className="text-base">Advanced parcel tracking features will be implemented here</p>
            </div>
          </div>
        );
      case 'customers':
        return (
          <div className="p-6 lg:p-8 space-y-8 w-full">
            <div className="space-y-2">
              ...
              <p className="text-muted-foreground text-lg">Manage customer accounts and profiles</p>
            </div>
            <div className="w-full p-12 text-center text-muted-foreground border-2 border-dashed border-border rounded-lg bg-card">
              <UserCheck className="h-16 w-16 mx-auto mb-6 text-muted-foreground" />
              <h3 className="text-xl font-medium mb-2">Customer Management System</h3>
              <p className="text-base">Customer management features will be implemented here</p>
            </div>
          </div>
        );
      case 'reviews':
        ...
        return (
          <div className="p-6 lg:p-8 space-y-8 w-full">
            ...
            <div className="w-full p-12 text-center text-muted-foreground border-2 border-dashed border-border rounded-lg bg-card">
              ...
              <p className="text-base">Business intelligence and analytics will be implemented here</p>
            </div>
          </div>
        );
      case 'reports':
        return (
          <div className="p-6 lg:p-8 space-y-8 w-full">
            <div className="space-y-2">
              ...
              <p className="text-muted-foreground text-lg">Generate and export business reports</p>
            </div>
            <div className="w-full p-12 text-center text-muted-foreground border-2 border-dashed border-border rounded-lg bg-card">
              <FileText className="h-16 w-16 mx-auto mb-6 text-muted-foreground" />
              <h3 className="text-xl font-medium mb-2">Report Generation</h3>
              <p className="text-base">Comprehensive reporting features will be implemented here</p>
            </div>
          </div>
        );
      default:
